...
func (w *serviceImplWriter) channel_read(def *model.Definition, m *model.Method) error {
	out := m.Channel.Out
	if out == nil {
		return nil
	}
...
func (w *serviceImplWriter) channel_write(def *model.Definition, m *model.Method) error {
	in := m.Channel.In
	if in == nil {
		return nil
	}
