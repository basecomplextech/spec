...
var yyAct = [...]int8{
	63, 98, 64, 93, 99, 43, 47, 55, 48, 49,
	50, 51, 52, 53, 45, 47, 109, 48, 49, 50,
	51, 52, 53, 45, 47, 75, 48, 49, 50, 51,
	52, 53, 45, 119, 72, 120, 39, 122, 113, 111,
	103, 44, 100, 69, 38, 88, 60, 56, 101, 62,
	47, 77, 48, 49, 50, 51, 52, 53, 45, 71,
	74, 74, 67, 91, 37, 68, 36, 44, 78, 58,
	66, 89, 82, 35, 81, 80, 25, 65, 24, 76,
	40, 23, 121, 86, 33, 115, 114, 92, 107, 31,
	106, 84, 8, 6, 104, 105, 57, 34, 117, 47,
	110, 48, 49, 50, 51, 52, 53, 45, 5, 85,
	95, 116, 48, 96, 50, 51, 52, 53, 94, 87,
	16, 123, 17, 124, 18, 19, 20, 67, 108, 79,
	68, 30, 29, 28, 27, 66, 26, 3, 61, 1,
	97, 118, 112, 102, 90, 83, 73, 15, 14, 54,
	70, 13, 42, 12, 41, 59, 11, 7, 10, 4,
	21, 32, 2, 9, 22, 46,
}

var yyPact = [...]int16{
	131, -1000, 100, 77, -1000, 76, -1000, 115, -1000, 64,
	-1000, -1000, -1000, -1000, -1000, -1000, 124, 122, 121, 120,
	119, 72, -1000, -1000, -1000, 83, 51, 44, 42, 22,
	14, -1000, -1000, 62, -1000, -1000, 95, -1000, -1000, -1000,
	82, 46, 25, -1000, 58, -1000, -1000, -1000, -1000, -1000,
	-1000, -1000, -1000, -1000, 20, 11, 2, -1000, -1000, -1000,
	61, 28, 95, 116, -1000, 55, 53, -1000, -1000, -1000,
	-1000, 58, -1000, -1000, 75, -1000, 96, -1000, -1000, -1000,
	123, 107, 21, 47, 106, 18, -1000, -1000, -1000, -1000,
	24, 106, 73, 71, 53, -1000, -1000, -12, -1000, 58,
	-1000, -1000, 15, 13, 69, 68, -1000, -1000, -1000, 95,
	85, -1000, 6, 9, -1000, -1000, -1000, -1000, 65, 12,
	58, -1000, 58, -1000, -1000,
}

var yyPgo = [...]uint8{
	0, 165, 4, 164, 163, 162, 161, 160, 159, 0,
	2, 158, 157, 156, 155, 154, 153, 5, 152, 151,
	150, 149, 148, 147, 7, 146, 145, 144, 143, 142,
	141, 1, 140, 3, 139, 138, 128,
}
...
var yyChk = [...]int16{
	...
	-27, 16, -10, -33, 12, 4, 7, -32, -31, -2,
	24, 24, -28, 16, -10, -33, 17, 17, -36, 28,
	-9, 24, -29, 25, 17, 17, -31, 13, -30, 27,
	26, 17, 25, -9, -9,
}
...
var yyDef = [...]int8{
	...
	0, 65, 0, 0, -2, -2, -2, 69, 66, 0,
	36, 53, 0, 60, 0, 0, 55, 56, 64, 70,
	0, 54, 62, 0, 57, 58, 67, 68, 0, 0,
	0, 59, 0, 61, 63,
}
...
var yyTok1 = [...]int8{
	...
	3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
	3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
	16, 17, 3, 3, 28, 25, 21, 3, 3, 3,
	3, 3, 3, 3, 3, 3, 3, 3, 3, 24,
	27, 18, 26, 3, 3, 3, 3, 3, 3, 3,
	3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
	3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
...
yydefault:
	...
	case 54:
		...
		{
			if debugParser {
				fmt.Println("method", yyDollar[1].ident, yyDollar[2].method_input, yyDollar[3].method_output, yyDollar[4].method_channel)
			}
			yyVAL.method = &ast.Method{
				Name:    yyDollar[1].ident,
				Input:   yyDollar[2].method_input,
				Output:  yyDollar[3].method_output,
				Channel: yyDollar[4].method_channel,
			}
		}
	case 55:
		yyDollar = yyS[yypt-3 : yypt+1]
